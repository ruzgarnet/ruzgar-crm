...
<body>
    ...
    <script src="/assets/admin/js/plugins.js?v=1.1"></script>
    <script src="/assets/admin/js/masks.js?v=1.1"></script>
    <script src="/assets/admin/js/modals.js?v=1.1"></script>
    <script src="/assets/admin/js/common.js?v=1.1"></script>
</body>
